        ...
        <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
          ...
          <el-menu :default-openeds="['1', '2']" :router= true active-text-color="#66ccff"
            ...
            <el-submenu index="1">
              ...
              <el-menu-item-group>
                <el-menu-item index="goodsPreview">商品预览</el-menu-item>
                <el-menu-item index="myCart">购物车</el-menu-item>
                <el-menu-item index="myOrders">我的订单</el-menu-item>
                <el-menu-item index="registerstore">注册商铺</el-menu-item>
                <el-menu-item index="mycenter">个人中心</el-menu-item>
              </el-menu-item-group>
            </el-submenu>
          </el-menu>
        </el-aside>
